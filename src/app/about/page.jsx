...
export default function About() {
  ...
  return (
    <main>
      <h1 className={h1}>Sobre a Newletter "Front-End Insights"</h1>
      ...
      <ol className='list-decimal pl-4 [&>li]:mt-2'>
        <li><strong>Conhecimento atualizado:</strong> Nossa equipe de especialistas está sempre atenta às últimas novidades e tendências no mundo do front-end. Ao assinar a Front-End Insigths, você receberá informações atualizadas sobre frameworks, bibliotecas, práticas recomendadas e muito mais.</li>
        ...
        <li><strong>Recursos selecionados:</strong> Navegar pela imensidão de recursos disponíveis para deenvolvedores front-end pode ser esmagador. Na Front-End Insights, selecionamos cuidadosamente os melhores recursos, como tutoriais, artigos, vídeos e ferramentas, para facilitar sua jornada de aprendizdo.</li>
      </ol>

      <h2 className={h2}>Quem está por trás da Front-End Insights?</h2>
      <p className={p}>A Front-End Insights é criada e cuidadosamente curada por uma equipe de especialistas apaixonados por desenvolvimento front-end. Nossos colaboradores têm ampla expêriencia no setor e estão ansiosos para compartilhar seus conhecimentos e insights com você. Juntos, buscamos fornecer um conteúdo relevante e de qualidade para ajudar você a se destacar no mundo front-end.</p>
